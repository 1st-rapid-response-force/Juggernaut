    ...
    */
    ...
    'backend' => [
        ...
        'awards' => [
            ...
            'restore_error' => 'There was a problem restoring this award. Please try again.',
            'update_error' => 'There was a problem updating this award. Please try again.',
            'failsafe_delete' => 'This award must be deleted first before it can be destroyed permanently.',
            'failsafe_restore' => 'This award is not deleted so it can not be restored.',
            'picture_error' => 'There was a problem uploading your picture for this award. Please try again.',
            'picture_clear_error' => 'There was a problem removing your picture for this award. Please try again.',
            'mark_error' => 'There was a problem updating this award. Please try again.',
        ],
        'qualifications' => [
            'create_error' => 'There was a problem creating this qualification. Please try again.',
            'delete_error' => 'There was a problem deleting this qualification. Please try again.',
            'not_found' => 'That qualification does not exist.',
            'restore_error' => 'There was a problem restoring this qualification. Please try again.',
            'update_error' => 'There was a problem updating this qualification. Please try again.',
            'failsafe_delete' => 'This qualification must be deleted first before it can be destroyed permanently.',
            'failsafe_restore' => 'This qualification is not deleted so it can not be restored.',
            'picture_error' => 'There was a problem uploading your picture for this qualification. Please try again.',
            'picture_clear_error' => 'There was a problem removing your picture for this qualification. Please try again.',
            'mark_error' => 'There was a problem updating this qualification. Please try again.',
        ],
        'calendar' => [
            ...
            'restore_error' => 'There was a problem restoring this event. Please try again.',
