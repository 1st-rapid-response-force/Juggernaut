...
return [
	...
	*/
	...
	'backend' => [
        ...
        'awards' => [
            'created' => 'created award',
            'deleted' => 'deleted award',
            'permanently_deleted' => 'permanently deleted award',
            'published' => 'published award',
            'unpublished' => 'unpublished award',
            'updated' => 'updated award',
            'restored' => 'restored award',
        ],
        'qualifications' => [
            'created' => 'created qualification',
            'deleted' => 'deleted qualification',
            'permanently_deleted' => 'permanently deleted qualification',
            'published' => 'published qualification',
            'unpublished' => 'unpublished qualification',
            'updated' => 'updated qualification',
            'restored' => 'restored qualifcation',
        ],
        'calendars' => [
