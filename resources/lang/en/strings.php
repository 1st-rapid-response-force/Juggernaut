...
return [
    ...
    */
    ...
    'frontend' => [
        ...
        'documentation' => [
            'about_phoenix' => 'About Phoenix',
            'about_phoenix_text' => '<p>Phoenix is unit management software built by Unit-Forge. Built with the intention of making community management easier, integrating popular third party applications, and providing a modern web API all into one product. </p><p>The software originally was built and designed for ARMA MILSIM units and is based on its predecessor Catalyst.</p>'
        ],
    ],
];