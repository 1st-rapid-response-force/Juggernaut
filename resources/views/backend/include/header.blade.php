        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{\Auth::User()->member->avatar}}" class="user-image" alt="User Avatar"/>
                        <span class="hidden-xs">{{ \Auth::User()->member }}</span>
                    </a>

                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{\Auth::User()->member->avatar}}" class="img-circle" alt="User Avatar" />
                            <p>
                                {{  \Auth::User()->member }} - Administrator
                            </p>
                        </li>
