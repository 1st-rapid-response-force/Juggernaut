...
@section('content')
    {{ Form::open(['route' => ['admin.calendar.update',$event->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'put', 'files' => false]) }}
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.calendar.edit_event') }}</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('title', $event->title, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.unit.calendar.events.title'),'required' => 'required']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('start_time', $event->start_time->setTimezone(\Auth::User()->timezone)->format('m/d/Y h:i A'), ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.unit.calendar.events.start_date'),'required' => 'required', 'id' =>'start_date']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('end_time', $event->end_time->setTimezone(\Auth::User()->timezone)->format('m/d/Y h:i A'), ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.unit.calendar.events.end_date'),'required' => 'required', 'id' =>'end_date']) }}
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('url', $event->url, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.unit.calendar.events.url')]) }}
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('color', $event->color, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.unit.calendar.events.color'), 'id' =>'color']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="pull-left">
                {{ link_to_route('admin.calendar.index', trans('buttons.general.cancel'), [], ['class' => 'btn btn-primary btn-xs']) }}
                {!! $event->getDeleteButtonAttribute() !!}
