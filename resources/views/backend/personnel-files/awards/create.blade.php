...
@section ('title', trans('labels.backend.personnel-files.awards.management') . ' | ' . trans('labels.backend.personnel-files.awards.create'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.personnel-files.awards.management') }}
        <small>{{ trans('labels.backend.personnel-files.awards.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.personnel-file.award.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'files' => true]) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.personnel-files.awards.create') }}</h3>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.unit.awards.name'),'required' => 'required']) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.unit.awards.description')]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
