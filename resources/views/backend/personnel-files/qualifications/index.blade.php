...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.personnel-files.qualifications.published') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.personnel-files.qualifications.published') }}</h3>
